...
function cargarNombres(e) {
     ...
     // Leer las variables
     const apykey = '53ae89eb5f3cd54814a53cc2d9085fc4';
     ...
     let url = `http://ws.audioscrobbler.com/2.0/?method=geo.gettopartists&country=${ origenSeleccionado }&api_key=${ apykey }&format=json`;
